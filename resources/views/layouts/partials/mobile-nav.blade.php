<section class="w-full flex flex-col justify-between items-center py-4 flex md:hidden" x-data="{show: false}">
    ...
    <ul class="flex flex-col w-full mt-8 items-start" x-show.transition="show"
        ...
        @else
            <li class="py-1 bg-primary-500 rounded-sm text-center">
